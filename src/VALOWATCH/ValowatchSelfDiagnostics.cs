...
internal static class ValowatchSelfDiagnostics
{
        ...
        bool includeUpdateDownload)
    {
        ...
        [
            ...
            new("PC全体音声取得", appExecutablePath, AppContext.BaseDirectory, ["--check-system-loopback"]),
            ...
            new("PC音声コマンド", appExecutablePath, AppContext.BaseDirectory, ["--check-pc-audio-command"]),
