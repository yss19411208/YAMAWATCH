...
internal static class RuntimeLogMessageCollector
{
    ...
    private static bool ShouldMirrorLineToDiscord(string line)
    {
        ...
        [
            ...
            "Discord.Net Warning: Dave encrypt",
            "Discord gateway disconnected; Discord.Net will reconnect automatically.",
            "Start agent Discord gateway disconnected; health monitor will restart it if it does not recover.",
            "GatewayReconnectException: Server requested a reconnect",
            "transient network reconnect warning",
            "Failed to decrypt audio packet",
            "Failed to encrypt dave audio",
            "DecryptionFailure",
            "MissingKeyRatchet",
            "WebSocketException",
            ...
            "Screen stream public URL is not reachable yet",
            "[Stream] fMP4 WebSocket screen stream connection stopped",
            "[Stream] fMP4 WebSocket screen stream connection closed",
            "[Stream] fMP4 live init response failed",
            "[Stream] fMP4 live fragment response failed",
            "[Stream] fMP4 live encoder did not produce",
            "fMP4 live encoder is not running",
            "fMP4 live encoder stopped after buffered fragments were exhausted",
            "SocketException (10053)",
            "Screen stream health diagnostic notification skipped because Discord was unavailable",
            "Screen stream restart failure notification skipped because Discord was unavailable",
            "Stream slash command was already acknowledged before defer",
            "Discord startup timed out during Discord voice channel connect",
            "Discord voice connect starting",
            "Discord voice connect completed",
            "Discord voice connect task failed before timeout",
            ...
            "Discord voice channel connect finished after timeout after cleanup",
            "Discord voice channel connect finished after timeout with no reusable voice client",
            "Discord voice channel connect observed a disposed voice client during retry",
            "Discord startup failed. Stopping Discord client before retry. Exception: System.ObjectDisposedException",
            "Timed out while waiting for the next fMP4 WebSocket fragment",
            "Timed out while waiting for the next fMP4 live fragment",
            "そのようなホストは不明です",
            "AcquireNextFrame failed",
            "DDA ReleaseFrame failed",
            "Desktop duplication capture was unavailable; falling back to gdigrab",
